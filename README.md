...
```
cd existing_repo
git remote add origin https://gitlab.epfl.ch/cs214/ul/cs-214-2025-unguided-lab/ul2025app68.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.epfl.ch/cs214/ul/cs-214-2025-unguided-lab/ul2025app68/-/settings/integrations)
